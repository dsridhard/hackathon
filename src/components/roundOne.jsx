      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <InputLabel id="teamlist">Upload Presenataion</InputLabel>
            <TextField
              sx={{ marginY: "10px" }}
              type="file"
              fullWidth
            ...
            <Typography color="black">
              <strong>Note</strong>: Every team should submit a{" "}
              <strong>ZIP</strong> file named as{" "}
              <Typography color="red" marginY="10px">
                Team Name:
              </Typography>
...
."
                ...
                <ListItem>
                  <ListItemText
                    primary="📜 Documents – Final Presentations to be submitted.
                    .
."
                  />
                </ListItem>
